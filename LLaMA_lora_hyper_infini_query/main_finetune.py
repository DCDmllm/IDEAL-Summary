...
def get_args_parser():
    ...
    parser.add_argument('--n_lora_layers', default='0-32', type=str, help="")

    parser.add_argument('--segment_size', default=512, type=int, help='infini transformer segment size')
    parser.add_argument('--instruc_end', type=str2bool, nargs='?', const=True, default=False, help='add instruction and the end of input')
...
def main(args):
    ...
    dataset_train = FinetuneDataset(args.data_path, llama_tokenzier_path,
                    max_tokens=args.max_seq_len, segment_size=args.segment_size, partition="train", instruc_end=args.instruc_end, loss_only_labels=args.loss_only_labels)
    print(dataset_train)

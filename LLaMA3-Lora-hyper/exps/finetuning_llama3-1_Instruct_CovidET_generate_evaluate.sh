...
output_dir="${path}/outputs/LLaMA3-1-Lora-hyper/${dataset}/b32_epoch${epochs}_warme1_lorar${lora_rank}_lora${lora_targets}_nhyper${n_hyper_lora_layers}_diffe_parallel_blr6e3_lossOlabels${loss_only_labels}_maxseq${max_seq_len}_flashattn${flash_attention2}_bf16${bf16}_${tag}/"

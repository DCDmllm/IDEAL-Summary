...
min_gen_len=30
lora_rank=8
lora_targets="Q,V,FFN_UP,FFN_DOWN"

your_path="/home"
output_dir="${your_path}/outputs/LLaMA_lora_bias/${dataset}/b32_epoch${epochs}_warme1_lorar${lora_rank}_lora${lora_targets}_blr6e3_maxseq$max_seq_len/"

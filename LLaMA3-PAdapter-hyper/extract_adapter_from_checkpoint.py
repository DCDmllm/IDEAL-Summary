...
def main(
    ...
    adapter_params['padapter_size'] = args.padapter_size
    adapter_params['padapter_layers'] = args.padapter_layers
    adapter_params['hyper_padapter_layers'] = args.hyper_padapter_layers

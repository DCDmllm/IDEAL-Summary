...
def get_args_parser():
    parser = argparse.ArgumentParser('LLama3 Lora hypernetwork finetuning', add_help=False)
    ...
    parser.add_argument('--padapter_size', default=16, type=int, help='parallel adapter bottleneck size')
    parser.add_argument('--padapter_layers', default='0-32', type=str, help="")

    # hyper
    parser.add_argument('--hyper_padapter_layers', default='24-32', type=str, help="")
...
def main(args):
    ...
    dataset_train = FinetuneDataset(args.data_path, llama_tokenzier_path,
                    max_tokens=args.max_seq_len, partition="train", loss_only_labels=args.loss_only_labels, hyper_input_type=args.hyper_input_type)
    print(dataset_train)

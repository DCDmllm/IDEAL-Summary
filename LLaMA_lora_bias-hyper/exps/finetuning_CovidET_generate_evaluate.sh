...
path="/home"
output_dir="${path}/outputs/LLaMA_lora_bias-hyper/${dataset}/b32_epoch${epochs}_warme1_lorar8_lora${lora_targets}_nhyper16-32_diffe_parallel_blr6e3_maxseq$max_seq_len/"

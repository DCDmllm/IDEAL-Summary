    ...
    def __init__(self, params: ModelArgs):
        ...
        if params.flash_attention2:
            ...
            if is_flash_attn_2_available() and is_flash_attn_greater_or_equal_2_10():
                ...
                flash_attention2 = False
                print("------warn not use flash attention2")
        ...
        for layer_id in range(params.n_layers):
            ...
            if layer_id in self.lora_layers_id:
                ...
                if layer_id in self.hyper_lora_layers_id:
                    hyper_lora = True
            self.layers.append(TransformerBlock(layer_id, params, flash_attention2=flash_attention2, w_lora=w_lora, hyper_lora=hyper_lora))

...
def get_args_parser():
    ...
    parser.add_argument('--prompt_len', default=10, type=int, help='soft prompt length')
    parser.add_argument('--prompt_layers', default='0-32', type=str, help="")

    # hyper
    parser.add_argument('--hyper_prompt_layers', default='16-32', type=str, help="")
